...
<div class="pages " >
  ...
  <audio    id="welcometospedemy">
    <source src="<?php echo site_url(); ?>assets/Sound/welcometospedemy.mp3" type="audio/mp3" />
  </audio>
<div class="container-fluid " style="background-color: #00aeef ;padding-top: 70px;">
  <div class="row">
    <!-- <div class="">
      <img   class="zoom  container float-right card-img-top img-fluid    " id="mutebtn"  style=" width: 100px;
      margin-top: 0px;
      margin-left: 20px;
      border: 0;
      margin-bottom: 20px;
